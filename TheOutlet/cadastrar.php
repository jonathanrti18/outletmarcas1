  ...
  <body>
    ...
    <div class="container" id="columns">
        ...
        <div class="breadcrumb clearfix">
            <!--<a class="home" href="https://rmendes.com.br/" title="Retornar a Home">Página Inicial</a>
        ...
        <div class="page-content">
					        ...
					        <div class="col-sm-6">
					            <div class="box-authentication">
					                                            <h3>Não Possuo Cadastro</h3>
					                    <!-- <p>Please enter your email address to create an account.</p> -->
                                                                                    <form action="ptcadastrarclie.php" method="post">
					                    <label>Login</label>
                                                            <input type="login" name="login" id="login" required class="form-control">
					                    <label>Senha</label>
                                                            <input type="password" name="senha" id="senha" required maxlength="9" class="form-control senha">
					                    <label>Nome</label>
