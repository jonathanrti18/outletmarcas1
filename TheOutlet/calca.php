    	...
    	<div id="total">
			...
			<div class="camisas">
				...
				<figure class="camisa1">
					<a href="calcachino.php"><img src="img/calcas/calca1.jpg"></a>
						
				</figure>
				<figure class="camisa2">
					<a href="calcachino1.php"><img src="img/calcas/calca2.jpg"></a>
				</figure>
				<figure class="camisa1">
					<a href="calcachino2.php"><img src="img/calcas/calca3.jpg"></a>
				</figure>
				<figure class="camisa2">
					<a href="calcachino3.php"><img src="img/calcas/calca4.jpg"></a>
				</figure>
				<figure class="camisa1">
					<a href="calcajeans.php"><img src="img/calcas/calca5.jpg"></a>
				</figure>
				<figure class="camisa2">
					<a href="calcajeans1.php"><img src="img/calcas/calca6.jpg"></a>
				</figure>
			</div>
		</section>
		<div>
