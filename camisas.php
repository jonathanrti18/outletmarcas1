		...
		<section>
			<div class="camisas">
				...
				<figure class="camisa1">
					<a href="camisaguns.php"><img src="img/camisas/camisagunsazul.jpg"></a>
						
				</figure>
				<figure class="camisa2">
					<a href="camisajackson.php"><img src="img/camisas/camisajacksonmarinho.jpg"></a>

				</figure>
				<figure class="camisa1">
					<a href="camisajagger.php"><img src="img/camisas/camisajaggerbranca.jpg"></a>
				</figure>
				<figure class="camisa2">
					<a href="camisamorrison.php"><img src="img/camisas/camisamaquine.jpg"></a>
				</figure>
				<figure class="camisa1">
					<a href="camisastars.php"><img src="img/camisas/camisastarts.jpg"></a>
				</figure>
				<figure class="camisa2">
					<a href="camisatricoline.php"><img src="img/camisas/camisatricoline.jpg"></a>
				</figure>
			</div>
		</section>
			<div>
